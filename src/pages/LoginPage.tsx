      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <img
            src={yakuLogo}
            alt="YacuControl"
            style={{ width: '180px', objectFit: 'contain', mixBlendMode: 'multiply' }}
          />
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            ...
            <div
              style={{ display: 'flex', alignItems: 'center', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '10px 12px', gap: '8px', backgroundColor: '#fff' }}
          ...
          <button
            type="submit"
            style={{ marginTop: '4px', backgroundColor: '#38bdf8', color: '#fff', fontWeight: 600, fontSize: '14px', borderRadius: '8px', padding: '12px', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}
        ...
        <div style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
          <a href="#" style={{ fontSize: '12px', color: '#94a3b8', textDecoration: 'none' }}>
