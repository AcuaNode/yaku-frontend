  ...
  return (
    <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px 16px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', marginTop: '14px' }}>
        ...
        <span style={{ fontSize: '11px', color: '#94a3b8' }}>Rango: {lectura.rangoMin}-{lectura.rangoMax}</span>
...
export default function EstanqueDetallePage() {
  ...
  if (loading) {
    return (
      <DashboardLayout>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '200px', color: '#94a3b8' }}>Cargando...</div>
      </DashboardLayout>
    )
  }
    ...
    <DashboardLayout>
      ...
      <div style={{ backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginBottom: '20px', padding: '20px 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
          ...
          <h2 style={{ fontSize: '15px', fontWeight: 700, color: '#0f172a', margin: 0 }}>Telemetría en Tiempo Real</h2>
        </div>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0', marginTop: '8px' }}>
          <TelemetriaCard label="TEMPERATURA"      lectura={detalle.telemetria.temperatura} />
          <div style={{ width: '1px', backgroundColor: '#f1f5f9', alignSelf: 'stretch' }} />
          <TelemetriaCard label="PH DEL AGUA"      lectura={detalle.telemetria.ph} />
          <div style={{ width: '1px', backgroundColor: '#f1f5f9', alignSelf: 'stretch' }} />
          <TelemetriaCard label="OXÍGENO DISUELTO" lectura={detalle.telemetria.oxigeno} />
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 300px', gap: '20px', marginBottom: '20px' }}>
        ...
        <div style={{ backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', padding: '20px 24px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
            <h2 style={{ fontSize: '15px', fontWeight: 700, color: '#0f172a', margin: 0 }}>Análisis Histórico</h2>
        ...
        <div style={{ backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', padding: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
            <h2 style={{ fontSize: '15px', fontWeight: 700, color: '#0f172a', margin: 0 }}>Equipos Asignados</h2>
            <button style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#38bdf8', fontSize: '13px', fontWeight: 600 }}>+ Vincular</button>
          </div>
      ...
      <div style={{ backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
        ...
        >
          <h2 style={{ fontSize: '15px', fontWeight: 700, color: '#0f172a', margin: 0 }}>Historial de Lecturas</h2>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '500px', fontSize: '13px' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                    {['FECHA', 'TEMPERATURA', 'PH', 'OXÍGENO', 'ESTADO'].map(h => (
                  ...
                  {detalle.historico.map((row, i) => (
                    <tr key={i} style={{ borderBottom: '1px solid #f8fafc' }}>
                      ...
                      <td style={{ padding: '12px' }}>
                        <span style={{ backgroundColor: '#ccfbf1', color: '#0d9488', fontSize: '11px', fontWeight: 700, padding: '2px 8px', borderRadius: '20px' }}>ÓPTIMO</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
